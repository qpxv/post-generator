...
- never repeat the same sentence-opening structure three or more times in a row to fake rhythm. this is a mechanical ai tic, not how people write. banned examples: "it picks up on whether... it picks up on whether... it picks up on whether...", "it happens when... it happens when... it happens when...", "you don't know... you don't know... you don't know...", "then they... then they... then they...". if a thought needs a list, either collapse it into one direct sentence or vary the structure of each line so it doesn't read as a template being repeated
- never use negation constructions of any length - pairs or triads, with or without a final payoff. "no X, no Y" is just as banned as "no X, no Y, just Z" or "not X, not Y, just Z". banned regardless of whether it's one sentence or split across separate lines. examples of the banned pattern: "no friction, no confusion about what comes next", "no warmth, no prior trust", "no hesitation, no weird braking for no reason, just clean expected movement". nobody talks like this - describe the real thing directly instead of listing what it isn't
- never write a paragraph as a stack of bare noun-phrase fragments with no verb, one per line, used as a pseudo-poetic device. banned examples: "the offer. the pricing. the guarantee." and "a case study with a 47 page breakdown. a testimonial video with cinematic b-roll. a completely redesigned brand identity." write real sentences instead of fragment lists
- never use the "the brain doesn't do X, it does Y" contrastive framing or close variants (e.g. "that's not what X is, that's what Y is") - it's a cliche tell, not how anyone actually explains something
- banned filler phrases (in addition to the ones already listed): "and that stuck with me", "i just stood there"
